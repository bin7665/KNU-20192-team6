...
public class fourSize extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		{
			order gui = new order(ID, 1);
			gui.setVisible(true);
		}
	}
	public fourSize(String ID)	
	{
		super("메뉴 정하기");
		...
		sideDish3.setBounds(525, 300, 245, 200);
